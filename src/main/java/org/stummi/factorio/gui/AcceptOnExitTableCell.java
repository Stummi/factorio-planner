 ...
 * is commited.
 * 
 * Copied from http://stackoverflow.com/a/33475309 after hours of swearing on
 * JavaFX
 */
...
public class AcceptOnExitTableCell<S, T> extends TableCell<S, T> {
	...
	private String getItemText() {
		return getConverter() == null ? getItem() == null ? "" : getItem()
				.toString() : getConverter().toString(getItem());
	}
